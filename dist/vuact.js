...
function Vuact(store) {
  var component = (0, _component.createComponent)(store);
  return {
    store: store,
    component: component
  };
...
function createComponent(store) {
  ...
  return function component(cmp) {
    ...
    var name = cmp.name,
        _render = cmp.render,
        _cmp$mapProps = cmp.mapProps,
        _mapProps = _cmp$mapProps === undefined ? [] : _cmp$mapProps,
        _cmp$mapActions = cmp.mapActions,
        _mapActions = _cmp$mapActions === undefined ? [] : _cmp$mapActions,
        _cmp$computed = cmp.computed,
        computed = _cmp$computed === undefined ? {} : _cmp$computed,
        _cmp$methods = cmp.methods,
        methods = _cmp$methods === undefined ? {} : _cmp$methods,
        _cmp$components = cmp.components,
        components = _cmp$components === undefined ? {} : _cmp$components,
        _cmp$state = cmp.state,
        state = _cmp$state === undefined ? _lodash2.default.noop() : _cmp$state,
        _cmp$mounted = cmp.mounted,
        mounted = _cmp$mounted === undefined ? _lodash2.default.noop() : _cmp$mounted;
    ...
    var Component = function (_React$Component) {
      ...
      function Component(props) {
        ...
        _this.state = state.call(_this);
        _this.components = {};

        // Getters/Setters for properties.
        _lodash2.default.each(_this.state, function (value, propName) {
          Object.defineProperty(_this, propName, {
            enumerable: true,
            get: function get() {
              return _this.state[propName];
            },
            set: function set(newValue) {
              return _this.setState(_defineProperty({}, propName, newValue));
            }
          });
        });
        // Bound method calls.
        _lodash2.default.each(methods, function (fn, methodName) {
          _this[methodName] = fn.bind(_this);
        });
        // Bound getters.
        _lodash2.default.each(computed, function (fn, propName) {
          Object.defineProperty(_this, propName, {
            enumerable: true,
            get: fn.bind(_this)
          });
        ...
        // Components.
        _lodash2.default.each(components, function (fn, componentName) {
          if (typeof fn === 'function') fn = { render: fn };
          _lodash2.default.assign(fn, { name: componentName, components: components });
          _this.components[componentName] = component(fn);
        });
        return _this;
      }
      ...
      _createClass(Component, [{
         ...
         */
        value: function model(stateProperty, handler) {
          var _this2 = this;
          ...
          return {
            ...
            onInput: function onInput(event) {
              ...
              _this2[stateProperty] = typeof handler === 'function' ? handler.call(_this2, stateProperty, value) : value;
            }
          };
        }
        /**
        ...
        value: function render() {
          return _render.call(this, this.props, this.state);
        }
      }]);
    ...
    if (store && (_mapProps.length || _mapActions.length)) {
      return (0, _reactRedux.connect)(mapState(_mapProps), mapActions(_mapActions))(Component);
    }
    return Component;
  };
}
...
function createStore(opts) {
  var _opts$debug = opts.debug,
      ...
      state = _opts$state === undefined ? {} : _opts$state,
      _opts$mutations = opts.mutations,
      mutations = _opts$mutations === undefined ? {} : _opts$mutations,
      _opts$actions = opts.actions,
      actions = _opts$actions === undefined ? {} : _opts$actions,
      _opts$getters = opts.getters,
      getters = _opts$getters === undefined ? {} : _opts$getters;
   ...
   */
  function reducer() {
    var oldState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_STATE;
    var action = arguments[1];
  ...
  function mapState(array) {
    return function (store, props) {
      return array.reduce(function (memo, prop) {
  ...
  function mapActions(methods) {
    return function (dispatch, props) {
      return methods.reduce(function (memo, prop) {
        if (actions[prop]) {
          memo[prop] = function (payload) {
            return actions[prop]({ dispatch: dispatch, state: state, props: props }, payload);
          };
        }
        return memo;
      }, {});
